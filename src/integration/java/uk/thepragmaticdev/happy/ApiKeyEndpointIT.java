  ...
  void shouldReturnAllKeysOwnedByAuthenticatedAccount() {
    ...
    .then()
        ...
        .rootPath("get(0)")
          ...
          .body("deleted_date", is(nullValue()))
          ...
          .rootPath("get(0).scope")
            ...
            .body("gif", is(true))
            .body("video", is(false))
            .body("text.toxicity", is(true))
            .body("text.severe_toxicity", is(true))
            .body("text.identity_attack", is(true))
            .body("text.insult", is(true))
            .body("text.profanity", is(true))
            .body("text.threat", is(true))
        ...
        .rootPath("get(1)")
          ...
          .rootPath("get(1).scope")
            ...
            .body("gif", is(false))
            .body("video", is(true))
            .body("text.toxicity", is(false))
            .body("text.severe_toxicity", is(false))
            .body("text.identity_attack", is(false))
            .body("text.insult", is(false))
            .body("text.profanity", is(false))
            .body("text.threat", is(false))
        .statusCode(200);
  }
  ...
  void shouldCreateKey() {
    ...
    var response = given()
        ...
        .then()
          ...
          .body("scope.text.toxicity", is(true))
          .body("scope.text.severe_toxicity", is(true))
          .body("scope.text.identity_attack", is(true))
          .body("scope.text.insult", is(false))
          .body("scope.text.profanity", is(false))
          .body("scope.text.threat", is(false))
  ...
  void shouldCreateKeyWithDefaultValues() {
    ...
    var response = given()
        ...
        .then()
          ...
          .body("scope.video", is(false))
          .body("scope.text.toxicity", is(false))
          .body("scope.text.severe_toxicity", is(false))
          .body("scope.text.identity_attack", is(false))
          .body("scope.text.insult", is(false))
          .body("scope.text.profanity", is(false))
          .body("scope.text.threat", is(false))
  ...
  void shouldUpdateOnlyMutableKeyFields() {
    ...
    .when()
      ...
      .then()
        ...
        .body("scope.text.toxicity", is(request.getScope().getText().getToxicity()))
        .body("scope.text.severe_toxicity", is(request.getScope().getText().getSevereToxicity()))
        .body("scope.text.identity_attack", is(request.getScope().getText().getIdentityAttack()))
        .body("scope.text.insult", is(request.getScope().getText().getInsult()))
        .body("scope.text.profanity", is(request.getScope().getText().getProfanity()))
        .body("scope.text.threat", is(request.getScope().getText().getThreat()))
  ...
  void shouldUpdateOnlyNonNullKeyFields() {
    ...
    .when()
      ...
      .then()
        ...
        .body("scope.text.severe_toxicity", is(true))
        .body("scope.text.identity_attack", is(true))
        .body("scope.text.insult", is(true))
        .body("scope.text.profanity", is(true))
        .body("scope.text.threat", is(true))
